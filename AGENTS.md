...
<!-- Universal agent instructions (AGENTS.md). Read by Codex, GitHub Copilot CLI, Cursor, and other agents that load AGENTS.md. Always-on: this applies to every code-generating turn, not on demand. Source of truth: core/magikarp.md. -->
